...
# my needed packages
pacman -S pulseaudio pavucontrol fv vlc virt-manager libvirt-runit qemu qemu-guest-agent-runit nftables nftables-runit openvpn otf-font-awesome transmission-gtk
